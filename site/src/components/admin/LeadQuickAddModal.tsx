...
import { adminCreateManualLead } from '@/app/actions/leads'
...
export function LeadQuickAddModal({ vehicles, onClose, defaultVehicleId = '', defaultStage = 'novo', title = 'Novo lead' }: LeadQuickAddModalProps) {
  const router = useRouter()
  const [error, setError] = useState<string | null>(null)
  const [saving, setSaving] = useState(false)
  const [firstContactAt, setFirstContactAt] = useState('')
  const [storeVisitAt, setStoreVisitAt] = useState('')
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-graphite/40 p-4" role="dialog" aria-modal="true" aria-label={title}>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1">
                ...
                <input id="lead-name" name="name" autoComplete="name" placeholder="Ex.: Maria Silva" required className={inputClass} />
              </div>
              <div className="flex flex-col gap-1">
                <label htmlFor="lead-phone" className={labelClass}>Telefone</label>
                <input id="lead-phone" name="phone" type="tel" autoComplete="tel" placeholder="(98) 99999-9999" required className={inputClass} />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 border-t border-support-gray/15 pt-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <select id="lead-vehicle" name="vehicleId" defaultValue={defaultVehicleId} className={inputClass}>
            ...
            <div className="flex flex-col gap-1">
              ...
              <select id="lead-stage" name="stage" defaultValue={defaultStage} className={inputClass}>
          ...
          <div className="flex flex-col gap-3 border-t border-support-gray/15 pt-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input id="lead-scheduled-time" name="scheduledVisitTime" type="time" className={inputClass} />
              </div>
            </div>
          </div>
