...
export function VehicleSearchSort({
  ...
  return (
    <div className="mb-8 flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-4">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex min-h-11 shrink-0 items-center gap-1.5 rounded-full border border-white/25 px-3.5 py-2 text-sm font-bold text-white transition-colors hover:border-aguiar-red hover:text-aguiar-red-light lg:hidden"
          >
        ...
        <div className="relative lg:ml-auto">
          <select
            ...
            className="min-h-11 w-full appearance-none rounded-full border border-white/25 bg-graphite py-2.5 pl-4 pr-9 text-sm font-bold text-white transition-colors focus:border-aguiar-red focus:outline-none lg:w-auto"
          >
