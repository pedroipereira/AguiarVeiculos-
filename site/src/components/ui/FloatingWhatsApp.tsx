...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="floating-whatsapp fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105"
    >
